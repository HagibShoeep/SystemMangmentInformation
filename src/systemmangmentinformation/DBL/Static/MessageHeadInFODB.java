 ...
 * @author shoeep
 */
public class MessageHeadInFODB  {
 ...
 public  Object[] selectConnditioal(  String sql)throws Exception{
   ...
   Object  obj[]={ id , name   };
    ...
    public int update(int ID,String Name ,String  teachearName ,String scholeName,String vilageName)throws Exception{
        String  sql="update MessageHead set "
    ...
    public boolean insert(String Name ,String  teachearName ,String scholeName,String vilageName )throws Exception{
           ConnectionClasses con=new ConnectionClasses();
          // boolean b;
     //    DisplayValueModel1 instance = new DisplayValueModel1();
